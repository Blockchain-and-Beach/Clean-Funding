...
function charge(address, money) {
    ...
    var transferTransaction = nem2_sdk_1.TransferTransaction.create(nem2_sdk_1.Deadline.create(), nem2_sdk_1.Address.createFromRawAddress(address), [new nem2_sdk_1.Mosaic(new nem2_sdk_1.MosaicId('foo:token'), nem2_sdk_1.UInt64.fromUint(money))], nem2_sdk_1.PlainMessage.create('충전 완료'), nem2_sdk_1.NetworkType.MIJIN_TEST);
    //모자이크를 줄 계정의 private키
    var privateKey = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
